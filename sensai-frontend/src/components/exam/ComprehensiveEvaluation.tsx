...
export default function ComprehensiveEvaluation({ examId, sessionId, userSession, examTitle, score }: EvaluationProps) {
  ...
  const renderPerformanceBadge = (level: string) => {
    ...
    return (
      <span className={`px-3 py-1 rounded-md text-sm font-medium border ${colors[level as keyof typeof colors] || colors['Average']}`}>
        {level}
      </span>
    );
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#111111] rounded-xl p-6 border border-gray-700">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={isLoading}
              className="bg-gray-600 hover:bg-gray-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white px-4 py-2 rounded-md font-medium text-sm"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="bg-white text-black hover:opacity-90 disabled:bg-blue-700 disabled:cursor-not-allowed text-white px-4 py-2 rounded-md font-medium text-sm"
            >
        ...
        {error && (
          <div className="bg-red-900/20 border border-red-500 text-red-400 px-4 py-3 rounded-md mb-4">
        ...
        {isLoading && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-200 mb-2">Analyzing performance with AI...</p>
      ...
      {evaluation && (
        <>
          ...
          <div className="flex justify-center mb-6">
            <div className="bg-[#111111] rounded-md p-1 border border-gray-700">
              <button
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#111111] rounded-xl p-6 border border-gray-700">
                ...
                <div className="mt-6 p-4 bg-gray-700 rounded-md">
                  ...
                  <p className="text-gray-200">{evaluation.overall_summary.time_management}</p>
                </div>
              </div>
              ...
              <div className="bg-[#111111] rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-4">
                  {evaluation.question_by_question_analysis.map((qa) => (
                    <div key={qa.question_number} className="border border-gray-600 rounded-md p-4">
                      ...
                      <p className="text-gray-200 mb-3">{qa.detailed_feedback}</p>
                      ...
                      {qa.why_wrong && (
                        <div className="mb-3 p-3 bg-red-900/20 border-l-4 border-red-500 rounded">
                          ...
                          <p className="text-gray-200 text-sm">{qa.why_wrong}</p>
                        </div>
                      )}
                      ...
                      {qa.better_approach && (
                        <div className="mb-3 p-3 bg-blue-900/20 border-l-4 border-blue-500 rounded">
                          ...
                          <p className="text-gray-200 text-sm">{qa.better_approach}</p>
                        </div>
                      )}
                      ...
                      {qa.related_concepts.length > 0 && (
                        <div className="flex flex-wrap gap-2">
                          ...
                          {qa.related_concepts.map((concept, idx) => (
                            <span key={idx} className="px-2 py-1 bg-gray-700 text-gray-200 rounded text-xs">
                              {concept}
                            </span>
                          ))}
                        </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {evaluation.learning_recommendations.immediate_actions.map((action, index) => (
                      <div key={index} className="bg-gray-700 p-3 rounded-md border-l-4 border-red-400">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {Object.entries(evaluation.learning_recommendations.study_plan).map(([week, topics]) => (
                      <div key={week} className="bg-gray-700 p-4 rounded-md">
                    ...
                    <div className="space-y-2">
                      {evaluation.visual_insights.strength_areas.map((area, index) => (
                        <div key={index} className="flex justify-between items-center bg-gray-700 p-3 rounded">
                          <span className="text-gray-200">{area.topic}</span>
            ...
            <div className="space-y-6">
              <div className="bg-[#111111] rounded-xl p-6 border border-gray-700">
                ...
                <div className="mt-6 p-4 bg-gray-700 rounded-md">
                  ...
                  <p className="text-gray-200">{evaluation.teacher_insights.peer_collaboration}</p>
                </div>

                {/* Assessment Modifications */}
                <div className="mt-6 p-4 bg-gray-700 rounded-md">
                  <h4 className="font-semibold text-green-400 mb-2">Assessment Modifications</h4>
                  <p className="text-gray-200">{evaluation.teacher_insights.assessment_modifications}</p>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="space-y-3">
                    {evaluation.knowledge_gaps.map((gap, index) => (
                      <div key={index} className="bg-gray-700 p-4 rounded-md border-l-4 border-red-400">
                ...
                <div className="mt-6 bg-gray-700 p-4 rounded-md">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-gray-200">{evaluation.comparative_analysis.grade_interpretation}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-400">Improvement Potential:</span>
                      <p className="text-gray-200">{evaluation.comparative_analysis.improvement_potential}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-400">Benchmark Comparison:</span>
                      <p className="text-gray-200">{evaluation.comparative_analysis.benchmark_comparison}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-400">Next Level Requirements:</span>
                      <p className="text-gray-200">{evaluation.comparative_analysis.next_level_requirements}</p>
                    </div>
                  </div>
                </div>
              </div>
