    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-medium mb-2">Exam Not Found</h2>
      ...
      <div className="max-w-7xl mx-auto py-8 px-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-light mb-2">{exam.title}</h1>
            ...
            <div className="flex items-center space-x-3">
              <button
                onClick={copyExamUrl}
                className="bg-[#1A1A1A] hover:bg-gray-600 px-4 py-2 rounded-md transition-colors flex items-center"
              >
              ...
              <Link
                href={`/exam/${examId}`}
                className="bg-white text-black hover:opacity-90 px-4 py-2 rounded-md transition-colors flex items-center"
              >
                ...
                <div className="bg-[#111111] p-6 rounded-md">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-light">{getCompletionRate()}%</p>
                    </div>
                ...
                <div className="bg-[#111111] p-6 rounded-md">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-light">{getAverageScore()}%</p>
                    </div>
                ...
                {sessions.slice(0, 5).length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {sessions.slice(0, 5).map((session) => (
                      <div key={session.id} className="flex items-center justify-between p-3 bg-[#1A1A1A] rounded">
                        <div>
            ...
            <div className="space-y-6">
              <div className="bg-[#111111] p-6 rounded-md">
                ...
                <div className="space-y-3">
                  <Link
                    href={`/exam/${examId}`}
                    className="w-full bg-white text-black hover:opacity-90 px-4 py-2 rounded transition-colors flex items-center"
                  >
                    <Eye size={16} className="mr-2" />
                    Preview Exam
                  </Link>
                  <button
                    onClick={copyExamUrl}
                    className="w-full bg-[#1A1A1A] hover:bg-gray-600 px-4 py-2 rounded transition-colors flex items-center"
                  >
                    <Share2 size={16} className="mr-2" />
                    Copy Exam Link
                  </button>
        ...
        {activeTab === 'sessions' && (
          <div className="bg-[#111111] p-6 rounded-md">
            <h3 className="text-lg font-medium mb-4">All Sessions ({sessions.length})</h3>
            {sessions.length === 0 ? (
